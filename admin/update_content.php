...
<section class="video-form">
   ...
   <h1 class="heading">Контентыг шинэчлэх</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Төлөв шинэчлэх <span>*</span></p>
      <select name="status" class="box" required>
         <option value="<?= $fecth_videos['status']; ?>" selected><?= $fecth_videos['status'] == 'active' ? 'Идэвхтэй' : 'Идэвхгүй'; ?></option>
         <option value="active">Идэвхтэй</option>
         <option value="deactive">Идэвхгүй</option>
      </select>
      <p>Гарчиг шинэчлэх <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Видеоны гарчиг оруулна уу" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Тайлбар шинэчлэх <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Тайлбар бичнэ үү" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Жагсаалт шинэчлэх</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>-- Жагсаалт сонгох --</option>
         <?php
      ...
      <input type="submit" value="Контентыг шинэчлэх" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Контентыг үзэх</a>
         <input type="submit" value="Контентыг устгах" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Видео олдсонгүй! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Видео нэмэх</a></p>';
      }
   ?>
