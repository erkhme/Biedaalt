...
<section class="liked-videos">
   ...
   <h1 class="heading">Таалагдсан видеонууд</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">Видеог үзэх</a>
         <input type="submit" value="Хасах" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
      ...
      echo '<p class="empty">Одоогоор таалагдсан зүйл алга!</p>';
   }
   ?>
