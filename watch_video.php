...
<section class="edit-comment">
   <h1 class="heading">Сэтгэгдэл засах</h1>
   <form action="" method="post">
      <input type="hidden" name="update_id" value="<?= $fetch_edit_comment['id']; ?>">
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="Сэтгэгдлээ оруулна уу" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">Засахыг цуцлах</a>
         <input type="submit" value="Шинэчлэх" name="update_now" class="inline-btn">
      </div>
   </form>
</section>
<?php
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-heart"></i><span><?= $total_likes; ?> лайк</span></p>
      </div>
      <div class="tutor">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">Жагсаалтыг үзэх</a>
         <?php
            if($verify_likes->rowCount() > 0){
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>Таалагдсан</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="far fa-heart"></i><span>Таалагдах</span></button>
         <?php
            }
         ?>
      </form>
   ...
   <?php
         ...
         echo '<p class="empty">Одоогоор видео нэмэгдээгүй байна!</p>';
      }
   ?>
...
<section class="comments">
   ...
   <h1 class="heading">Сэтгэгдэл нэмэх</h1>

   <form action="" method="post" class="add-comment">
      <input type="hidden" name="content_id" value="<?= $get_id; ?>">
      <textarea name="comment_box" required placeholder="Сэтгэгдлээ бичнэ үү..." maxlength="1000" cols="30" rows="10"></textarea>
      <input type="submit" value="Сэтгэгдэл нэмэх" name="add_comment" class="inline-btn">
   </form>

   <h1 class="heading">Хэрэглэгчдийн сэтгэгдэл</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">Сэтгэгдэл засах</button>
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Энэ сэтгэгдлийг устгах уу?');">Сэтгэгдлийг устгах</button>
         </form>
         <?php
         }
         ?>
      ...
      <?php
         ...
         echo '<p class="empty">Одоогоор сэтгэгдэл нэмэгдээгүй байна!</p>';
      }
      ?>
      </div>
